...
public class Task7_CDManager {

	List<Task7_CD> arrCD = new ArrayList<Task7_CD>();

	/* Add a cd into List.
	 * Input: a cd object.
	 */
	public void addCD(Task7_CD cd) {
		arrCD.add(cd);
	}
	 ...
	 */
	Task7_CD getCD() throws IOException {
		...
		Task7_CD cd = new Task7_CD(id, name, singer, numOfSong, price);
		return cd;
	}
}
