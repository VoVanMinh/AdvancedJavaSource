...
public class Salary {
	...
	/*
	 * Calculate revenue of a employee. Input: a employee. Output: return float
	 * type.
	 */
	public float calRevenue(Employee emp) {
	...
	/*
	 * Calculate income taxes of a employee. Input: a employee. Output: return
	 * float type.
	 */
	public float calRevenueTax(Employee emp) {
		float result = 0;
	...
	/*
	 * Calculate taxes under the tax bracket. Input: a employee. Output: return
	 * array float type.
	 */
	...
	/*
	 * Calculate personal income tax. Input: a employee. Output: return float
	 * type.
	 */
	public float calTax(Employee emp) {
		float result = calRevenueTax(emp);
		float arr[] = arrTaxMoney();
		if (result > REVENUE[6] * UNIT) {
			result = arr[0] + arr[1] + arr[2] + arr[3] + arr[4] + arr[5] + (result - REVENUE[6] * UNIT) * TAX[6];
	...
	/*
	 * Calculate the employee's salary after taxes. Input: a employee. Output:
	 * return float type.
	 */
	public float calSalary(Employee emp) {
